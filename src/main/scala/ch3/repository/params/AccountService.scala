...
trait AccountService[Account, Amount, Balance] {
  def open(no: String,
           ...
           repo: AccountRepository): Try[Account]
  def close(no: String,
...
object AccountService extends AccountService[Account, Amount, Balance] {
  ...
  override def balance(no: String, repo: AccountRepository): Try[Balance] =
    repo.balance(no)
}
