...
/**
  ...
  * $ sbt
  * > console
  * scala > import ch7.stream._
  * scala > FrontOffice.main(Array(""))
  *
  * The updated balance for each account getsdisplayed periodically.
  */
object FrontOffice extends App with Logging {
  ...
  val path = "/home/weili/work/learning/functional_reactive_domain_modeling/src/main/resources/transactions.csv"
